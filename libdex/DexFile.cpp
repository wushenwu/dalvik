...
static struct listnode g_block_list;
list_init(&g_block_list);

void addBlockInfo(u4 off, u4 size, const char *typename, struct listnode *list)
{
...
void dexFileSetupBasicPointers(DexFile* pDexFile, const u1* data) {
    ...
    addBlockInfo(pHeader->fieldIdsOff, pHeader->fieldIdsSize, "field", &g_block_list);
    addBlockInfo(pHeader->methodIdsOff, pHeader->methodIdsSize, "method", &g_block_list);
    addBlockInfo(pHeader->protoIdsOff, pHeader->protoIdsSize, "proto", &g_block_list);
